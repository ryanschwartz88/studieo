...
DROP FUNCTION IF EXISTS public.search_projects(text, public.project_status, public.project_access_type, integer, integer, integer, boolean, text[], text, text[], text);

-- Update search_projects function to include custom_questions
