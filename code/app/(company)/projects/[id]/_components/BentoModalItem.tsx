          ...
          >
            ...
            {isOverflowing && (
              <>
                ...
                <div className="absolute bottom-2 right-2 p-1.5 rounded-md bg-white/80 dark:bg-black/80 border border-neutral-200 dark:border-white/[0.2] opacity-0 group-hover/modal:opacity-100 transition-opacity">
